...
class InterfaceMixin(ClientABC):
    ...
    def create_interfaces(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_interfaces(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def create_interface_bridges(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_interface_bridge(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def create_interface_vlan(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_interface_vlan(self, **args: Dict[str, Any]) -> requests.Response:
