...
class StatusMixin(ClientABC):
    ...
    def get_system_status_log(self, **filterargs: Dict[str, Any]) -> requests.Response:
    ...
    def get_openvpn_status(self, **filterargs: Dict[str, Any]) -> requests.Response:
