...
class UserMixin(ClientABC):
    ...
    def create_users(self, **args: Dict[str, Any]) -> Response:
    ...
    def delete_users(self, **args: Dict[str, Any]) -> Response:
    ...
    def create_ldap_auth_servers(self, **args: Dict[str, Any]) -> Response:
    ...
    def create_radius_auth_servers(self, **args: Dict[str, Any]) -> Response:
