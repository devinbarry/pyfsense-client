...
class SystemMixin(ClientABC):
    ...
    def delete_system_ca(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_system_certificates(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def update_console_settings(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def create_system_dns_server(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_system_dns_server(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def halt_system(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def create_system_reboot(self, **args: Dict[str, Any]) -> requests.Response:
    ...
    def delete_system_tunables(self, **args: Dict[str, Any]) -> requests.Response:
